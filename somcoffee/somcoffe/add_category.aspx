  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="staticBackdropLabel">Category Operations</h1>
...
<h6>Create new/delete/update product Category</h6>
</div>
</div>
...
<a href="javascript:void(0);" id="submitbtn" class="btn btn-submit me-2" onclick="submitcategory()">Submit</a>
...
<script src="assets/js/dataTables.bootstrap4.min.js"></script>
    <script>
        ...
        function datadisplay() {
            $.ajax({
                url: 'add_category.aspx/datadisplay',
                dataType: "json",
                type: 'POST',
                ...
                success: function (response) {
                    ...
                    for (var i = 0; i < response.d.length; i++) {
                        var id = response.d[i].CategoryId;
                        var name = response.d[i].CategoryName;
        ...
        function submitcategory() {
            ...
            if (isValid) {
                ...
                $.ajax({
                    url: 'add_category.aspx/submitcategory',
